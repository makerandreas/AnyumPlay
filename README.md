...
2. [Tap and hold](https://github.com/makerandreas/AnyumPlay/raw/refs/heads/main/Kicaumania.m3u) this link and then select "Copy URL" to copy the link.
3. Install OTT Navigator on your phone.
4. When opening the app for the first time, a provider window will be shown up. Select "Add Provider", paste the link that you've copied, and then tap "Apply".
5. The app will start scanning the playlist. This will take some time.
...
For more information regarding to the OTT Navigator app, go to this [OTT Navigator FAQ link](https://ottnav.github.io/faq.html).